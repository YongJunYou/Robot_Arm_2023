...
if("FALSE" STREQUAL "TRUE")
  ...
  set(mg966r_joy_DEVEL_PREFIX /home/yyj/catkin_ws/src/mg966r_joy/build/devel)
  ...
  set(mg966r_joy_INSTALL_PREFIX /usr/local)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mg966r_joy' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
